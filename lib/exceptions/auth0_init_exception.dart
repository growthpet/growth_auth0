...
/// Исключение входа через universal login
class Auth0LoginWithUniversalException extends Auth0Exception {
  Auth0LoginWithUniversalException([String? message]) : super(message);
}
